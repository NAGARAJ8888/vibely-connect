...
function StoryCard({ storyData }) {
  ...
  return (
    <div className="w-full max-w-[500px] h-[100vh] border-x-2 border-gray-800 pt-[10px] relative flex flex-col justify-center">
      ...
      <div className="absolute top-[10px]  w-full h-[5px] bg-gray-900 z-50">
        <div
          className="h-full w-[200px] bg-white transition-all duration-200 ease-linear z-50"
        ...
        <>
          <div className="w-[full] h-[90vh]  flex  items-center justify-center">
            {storyData?.mediaType == "image" && (
              <div className="w-[90%] z-50 flex  items-center justify-center">
                <img
                  src={storyData?.media}
                  alt=""
                  className="w-[80%] rounded-2xl  object-cover z-50"
                />
              </div>
            )}

            {storyData?.mediaType == "video" && (
              <div className="w-[80%] flex flex-col items-center justify-center object-contain -z-0">
